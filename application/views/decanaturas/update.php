				  ...
				  <div class="col-md-9">
				  	    <div class="row">
												  <div class="panel panel-default">
													  <div class="panel-heading">
													  	 <h1>Gestion Decanaturas <small>Actualizar</small></h1>
													  </div>
												  </div>
                                                          ...
                                                          <div class="row">
															     	   <form class="form-horizontal">
																	       ...
																	       <div class="form-group">
																		        ...
																		        <div class="col-xs-4">
																		         <input type="text" name="id_decanatura" placeholder="id decanatura" class="form-control" value="<?php echo $datos->id_decanatura?>">
																		        </div>
																		        <div class="col-xs-4">
                                                                            ...
                                                                            <div class="form-group">
																		        ...
																		        <div class="col-xs-4">
																		          <input type="text" name="nom_decanatura" placeholder="nombre" class="form-control" value="<?php echo $datos->nom_decanatura?>">
																		        </div>
																		        <div class="col-xs-4">
																		            <span class="help-block"><?php echo form_error('id_decanatura'); ?></span>
                                                                               </div>
																		     ...
																		     <div class="form-group">
																		        ...
																		        <div class="col-xs-4">
																		         <input type="text" name="jefe_decanatura" placeholder="jefe" class="form-control" value="<?php echo $datos->jefe_decanatura?>">
																		        </div>
																		         <div class="col-xs-4">
