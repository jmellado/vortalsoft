...
</section>  <!--cierre etiqueta del contenido principal que se abre despues del nav--> 
      ...
      <div class="container">
            	...
            	<div class="col-sm-8 col-sm-offset-2 text-center">
                        <ul class="list-inline center-block">
                            <li><a href="http://facebook.com"><img src="<?=base_url()?>/utilities/img/soc_fb.png"></a></li>
                            <li><a href="http://twitter.com"><img src="<?=base_url()?>/utilities/img/soc_tw.png"></a></li>
                            <li><a href="http://google.com"><img src="<?=base_url()?>/utilities/img/soc_gplus.png"></a></li>      
                        </ul>
                        <hr>
