...
<div class="col-md-4">
	...
	<div class="form-group">
		<label>Id</label>
		<input type="text" name="id" class="form-control" value="<?php echo $datos->id_profesor?>">
	</div>
	<div class="form-group">
		<label>Nombre</label>
		<input type="text" name="nombre" class="form-control" value="<?php echo $datos->nom_profesor?>">
	</div>
	<div class="form-group">
		<label>Apellido</label>
		<input type="text" name="apellido" class="form-control" value="<?php echo $datos->ape_profesor?>">
	</div>
	<div class="form-group">
		<label>Correo</label>
