				  ...
				  <div class="col-md-9">
				  	    <div class="row">
												  <div class="panel panel-default">
													  <div class="panel-heading">
													  	 <h1>Gestion Profesores <small>Actualizar</small></h1>
													  </div>
												  </div>
                                                          ...
                                                          <div class="row">
															     	   <form class="form-horizontal">
																	       ...
																	       <div class="form-group">
																		        ...
																		        <div class="col-xs-4">
																		         <input type="text" name="id" placeholder="id profesor" class="form-control" value="<?php echo $datos->id_profesor?>">
																		        </div>
																		        <div class="col-xs-4">
                                                                            ...
                                                                            <div class="form-group">
																		        ...
																		        <div class="col-xs-4">
																		          <input type="text" name="nombre" placeholder="nombre" class="form-control" value="<?php echo $datos->nom_profesor?>">
																		        </div>
																		        <div class="col-xs-4">
																		     ...
																		     <div class="form-group">
																		        ...
																		        <div class="col-xs-4">
																		         <input type="text" name="apellido" placeholder="apellidos" class="form-control" value="<?php echo $datos->ape_profesor?>">
																		        </div>
																		         <div class="col-xs-4">
