				  ...
				  <div class="col-md-9">
				  	    <div class="row">
												  <div class="panel panel-default">
													  <div class="panel-heading">
													  	 <h1>Gestion Carga Academica <small>Actualizar</small></h1>
													  </div>
												  </div>
															     	   ...
															     	   <form class="form-horizontal">
																	       ...
																	       <div class="form-group">
																		    ...
																		    <div class="form-group">
																		        ...
																		        <div class="col-xs-4">
																		         <input type="text" name="id1" placeholder="id materia" class="form-control" value="<?php echo $datos->id_materia?>">
																		        </div>
																		        <div class="col-xs-4">
                                                                            ...
                                                                            <div class="form-group">
																		        ...
																		        <div class="col-xs-4">
																		          <input type="text" name="ano" placeholder="ano" class="form-control" value="<?php echo $datos->año?>">
																		        </div>
																		        <div class="col-xs-4">
